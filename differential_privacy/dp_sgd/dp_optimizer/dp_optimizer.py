...
class DPMomentumOptimizer(tf.train.MomentumOptimizer):
  """Differentially private Momentum optimizer.
  """

  def __init__(self, learning_rate, momentum, eps_delta, sanitizer,
               sigma=None, use_locking=False, name="DPMomentum",
               batches_per_lot=1):
    ...
    Args:
      learning_rate: for MomentumOptimizer
    ...
    super(DPMomentumOptimizer, self).__init__(learning_rate, momentum,
                                                     use_locking, name)
...
class DPAdamOptimizer(tf.train.AdamOptimizer):
  ...
  def __init__(self, learning_rate, beta1, beta2, epsilon, eps_delta, sanitizer,
    ...
    super(DPAdamOptimizer, self).__init__(learning_rate, beta1, beta2, 
